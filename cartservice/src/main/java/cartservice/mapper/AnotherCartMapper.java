...
public class AnotherCartMapper {
    ...
    public static CartResposneDto fromCartToResponse(Carts carts){// MAPPING CART ENTITY TO RESPONSE DTO
        CartResposneDto resposneDtos=new CartResposneDto();
        resposneDtos.setCartId(carts.getId());
        resposneDtos.setTotal(carts.getTotal());
        resposneDtos.setCartStatus(carts.getCartStatus());
        resposneDtos.setBalanceStock(carts.getLeftItemStock());
